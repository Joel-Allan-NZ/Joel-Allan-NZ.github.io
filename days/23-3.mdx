...
<h1>
  <a href="https://adventofcode.com/2023/day/3">2023 Day 3 - Gear Ratios</a>
</h1>

## Part One

The solution here is a victim of being reworked to suit part 2, but the core idea is to walk down each line of the input, finding each number in turn and immediately checking the area around them for a symbol. No real algorithmic thinking here, just dotting Is and crossing Ts
...
Same deal as part one, but additionally group the partial numbers by adjacent symbols. For each \* symbol, if there are two adjacent numbers then add the product of those two.
